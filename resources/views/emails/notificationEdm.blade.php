                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img class="fullWidth"
                                                                        src="{{ asset('storage/emails/notificationEdm.png') }}"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h1
                                                                    ...
                                                                    <span class="tinyMce-placeholder">Please wait for
                                                                        approval Email</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0;">Be patient, we recieved your
                                                                        application and soon the confirmation email sent
                                                                        to
                                                                    <h4>{{ $patient->email }}</h4>
                                                                    </p>
                                                                </div>
